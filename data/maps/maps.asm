...
MapGroup_Indigo:
    ...
    map Route23Restored, TILESET_KANTO, TOWN, LANDMARK_ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
...
MapGroup_Cherrygrove:
    ...
    map UnionCaveCherry, TILESET_CAVE, CAVE, LANDMARK_UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
